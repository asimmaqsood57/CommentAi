...
exports.GenerateModule = GenerateModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [generate_service_1.GenerateService, prisma_service_1.PrismaService, openai_service_1.OpenAiService, firebase_service_1.FirebaseService, firebase_auth_guard_1.FirebaseAuthGuard],
    })
], GenerateModule);
